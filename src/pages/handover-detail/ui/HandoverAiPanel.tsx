...
function uniqueCitations(citations: NonNullable<ReturnType<typeof useHandoverChat>['messages'][number]['citations']>) {
  const seen = new Set<string>()
  return citations.filter((citation) => {
    const key = citation.title.trim().toLocaleLowerCase()
