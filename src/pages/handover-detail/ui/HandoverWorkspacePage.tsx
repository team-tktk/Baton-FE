    ...
    <header className={styles.workspaceHeader}>
      ...
      <div className={styles.workspaceTools}>
        ...
        {handover.status !== 'approved' && (
          <button className={isDemo ? styles.completeReceipt : undefined} disabled={completing} type="button" onClick={() => void complete()}>
            <Icon name="check" /> {completing ? '처리 중…' : isDemo ? '내용 확인 완료' : '인수인계 완료'}
          </button>
        )}
