...
import { HandoverChatPage, HandoverWorkspacePage } from '@/pages/handover-detail'
import { HandoverInboxPage } from '@/pages/handover-inbox'
import { NotFoundPage } from '@/pages/not-found'
import { ReviewDetailPage } from '@/pages/review-detail'
import { ReviewInboxPage } from '@/pages/review-inbox'

import { HandoverWorkspaceRedirect } from './HandoverWorkspaceRedirect'
...
export const router = createBrowserRouter([
  ...
  { path: '/handovers/:handoverId/arrival', element: <RequireAuth><HandoverWorkspaceRedirect /></RequireAuth> },
  { path: '/handovers/:handoverId/overview', element: <RequireAuth><HandoverWorkspaceRedirect /></RequireAuth> },
